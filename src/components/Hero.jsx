  ...
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY} `}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
        <img
          src={discount} alt="discount icon"
      ...
      <div className='flex flex-row justify-between items-center w-full'> 
        <h1 className='text-white ss:text-[72px] text-[52px] ss:leading-[100px] leading-[75px] flex-1 font-poppins font-semibold'>
      ...
      <h2 className='w-full text-white ss:text-[68px] text-[52px] ss:leading-[100px] leading-[75px] font-poppins font-semibold'>Payment Method.</h2>
